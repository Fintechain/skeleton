// Package runtime provides runtime mode implementations using FX dependency injection.
package runtime
...
func WithOptions(options ...fx.Option) RuntimeOption {
	return func(cfg *RuntimeConfig) {
...
func StartDaemon(opts ...RuntimeOption) error {
	...
	if len(cfg.Plugins) > 0 {
		options = append(options, fx.Invoke(func(runtime *Runtime) error {
	...
	options = append(options, fx.Invoke(func(lc fx.Lifecycle, runtime *Runtime) {
		lc.Append(fx.Hook{
