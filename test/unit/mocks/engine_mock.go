...
func (_m *MockEngine) Capabilities() storage.Capabilities {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() storage.Capabilities); ok {
		r0 = rf()
	} else {
...
func (_c *MockEngine_Capabilities_Call) Return(_a0 storage.Capabilities) *MockEngine_Capabilities_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// Create provides a mock function with given fields: name, path, config
func (_m *MockEngine) Create(name string, path string, config storage.Config) (storage.Store, error) {
	ret := _m.Called(name, path, config)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, storage.Config) (storage.Store, error)); ok {
		return rf(name, path, config)
	}
	if rf, ok := ret.Get(0).(func(string, string, storage.Config) storage.Store); ok {
		r0 = rf(name, path, config)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(string, string, storage.Config) error); ok {
		r1 = rf(name, path, config)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockEngine_Create_Call) Return(_a0 storage.Store, _a1 error) *MockEngine_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockEngine_Create_Call) RunAndReturn(run func(string, string, storage.Config) (storage.Store, error)) *MockEngine_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Name provides a mock function with no fields
func (_m *MockEngine) Name() string {
	ret := _m.Called()
...
func (_c *MockEngine_Name_Call) Return(_a0 string) *MockEngine_Name_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// Open provides a mock function with given fields: name, path
func (_m *MockEngine) Open(name string, path string) (storage.Store, error) {
	...
	var r0 storage.Store
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) (storage.Store, error)); ok {
		return rf(name, path)
	}
	if rf, ok := ret.Get(0).(func(string, string) storage.Store); ok {
		r0 = rf(name, path)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(storage.Store)
...
func (_c *MockEngine_Open_Call) Return(_a0 storage.Store, _a1 error) *MockEngine_Open_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockEngine_Open_Call) RunAndReturn(run func(string, string) (storage.Store, error)) *MockEngine_Open_Call {
	_c.Call.Return(run)
	return _c
}
