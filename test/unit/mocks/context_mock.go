...
func (_c *MockContext_Deadline_Call) Return(_a0 time.Time, _a1 bool) *MockContext_Deadline_Call {
...
func (_m *MockContext) WithValue(key interface{}, value interface{}) context.Context {
	...
	if rf, ok := ret.Get(0).(func(interface{}, interface{}) context.Context); ok {
		r0 = rf(key, value)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockContext_WithValue_Call) Return(_a0 context.Context) *MockContext_WithValue_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockContext_WithValue_Call) RunAndReturn(run func(interface{}, interface{}) context.Context) *MockContext_WithValue_Call {
	_c.Call.Return(run)
	return _c
}
